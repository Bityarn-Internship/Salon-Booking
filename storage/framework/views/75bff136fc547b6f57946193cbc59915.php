<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Inactive Employee Services'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title text-primary text-center">Inactive Employee Services</h4>

                    <div class="table-responsive">
                        <div class="col col-md-11 text-right">
                           <span style="display: inline-block"><h3><a class="btn btn-primary" href="<?php echo e(url('restoreEmployeeServices')); ?>"><b>Restore All</b>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <?php $__currentLoopData = $employeeServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="<?php echo e(url ('restoreEmployeeService/'.$employeeService->id)); ?>" title="Restore">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITYARN\Salon-Booking\resources\views/custom/employeeServices/viewTrashedEmployeeServices.blade.php ENDPATH**/ ?>