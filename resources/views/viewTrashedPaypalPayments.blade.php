...
<div class="col col-md-11 text-right">
    <h3><a class="deletebutton" href="{{url('restoreAllPaypalPayments') }}">Restore All</a></h3>
</div>
<table id="paypalView" class="table mb-0">
    ...
    @foreach($paypalpayments as $paypalpayment)
        <tr>
            ...
            <td><a class="deletebutton" href="{{url ('restorePaypalPayment/'.$paypalpayment->id) }}">Restore</a></td>
        </tr>
    @endforeach
    </tbody>
</table>
