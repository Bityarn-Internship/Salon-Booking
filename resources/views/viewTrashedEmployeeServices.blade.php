...
<div class="container ">
    <div class="row">
        <div class="col col-md-11 text-right">
            <h3><a class="btn btn-primary" href="{{url('restoreEmployeeServices') }}"><b>Restore All</b></a></h3>
        </div>
        <table id="employeeServicesView" class="table table-striped" style="width:100%">
            ...
            @foreach($employeeServices as $employeeService)
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="{{url ('restoreEmployeeService/'.$employeeService->id) }}">Restore</a></td>
                </tr>
            @endforeach
