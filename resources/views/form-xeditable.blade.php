...
@section('css')
    <!-- Plugins css -->
    <link href="{{ URL::asset('assets/libs/bootstrap-editable/css/bootstrap-editable.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
    <!-- Plugins js -->
    <script src="{{ URL::asset('assets/libs/bootstrap-editable/js/index.js') }}"></script>
