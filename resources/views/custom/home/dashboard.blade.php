                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-3">
                                    ...
                                    <p>Hi, {{ \App\Http\Controllers\EmployeesController::getEmployeeName(Session::get('employeeID')) }} </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="profile-img">
                                    <div class="mt-4">
                                        <a href="{{url('/userProfile')}}" class="btn btn-primary waves-effect waves-light btn-sm">View Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
