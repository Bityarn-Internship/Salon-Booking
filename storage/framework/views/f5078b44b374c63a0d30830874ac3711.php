...
<h4 class="card-title text-center">View Employee Services</h4>
<div class="col col-md-11 text-right">
    <h3><a href="<?php echo e(url('restoreEmployeeServices')); ?>"><b>Restore All</b></a></h3>
</div>
<table id="employeeServicesView" class="table mb-0">
    ...
    <?php $__currentLoopData = $employeeServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td><a href="<?php echo e(url ('restoreEmployeeService/'.$employeeService->id)); ?>">Restore</a></td>
        </tr>
