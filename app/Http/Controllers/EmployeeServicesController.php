...
class EmployeeServicesController extends Controller
{
    ...
    public function assign(){
        ...
        return view('assignServices',['employees'=>$employees,'services'=>$services]);
    }
    ...
    public function edit($id){
        ...
        $employees = Employee::all();
        $services = Service::all();
        return view('editEmployeeService', ['employeeService' => $employeeService,'employees'=>$employees, 'services'=>$services]);
    }
