...
<body>
    <form action = "<?php echo e(url('/updateEmployeeService/'.$employeeService->id)); ?>" method = "post" enctype="multipart/form-data">
        <h5 class="card-title text-center">Edit Employee Services</h5></br>
        <?php echo csrf_field(); ?>
        <div class="mb-3">
...
<?php /**PATH C:\Users\User\Projects\Bityarn\Laravel Admin\Admin\resources\views/editEmployeeService.blade.php ENDPATH**/ ?>