<header style="background-color:#556ee6;" id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="d-inline-block">
                <a href = "{{URL::to('/viewClientBookings/'.Auth::user()->id)}}">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="/clientProfile"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">@lang('User Profile')</span></a>
