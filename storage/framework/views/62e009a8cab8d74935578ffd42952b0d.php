        ...
        <table id="paypalView" class="table table-striped" style="width:100%">
            ...
            <?php $__currentLoopData = $paypalpayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paypalpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><a class="btn btn-danger" href="<?php echo e(url ('deletePaypalPayment/'.$paypalpayment->id)); ?>">Delete</a></td>
                </tr>
...
<?php /**PATH D:\BITYARN\Salon-Booking\resources\views/ViewPaypalPayments.blade.php ENDPATH**/ ?>