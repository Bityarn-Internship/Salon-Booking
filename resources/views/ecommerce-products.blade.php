...
@section('css')
    <!-- ION Slider -->
    <link href="{{ URL::asset('assets/libs/ion-rangeslider/css/ion.rangeSlider.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
    <!-- Ion Range Slider-->
    <script src="{{ URL::asset('assets/libs/ion-rangeslider/js/ion.rangeSlider.min.js') }}"></script>
