...
<div class="container ">
    <div class="row">
        <div class="col col-md-11 text-right">
            <h3><a class="btn btn-primary" href="<?php echo e(url('restoreMpesaPayments')); ?>">Restore All</a></h3>
        </div>
        <table id="mpesaView" class="table table-striped" style="width:100%">
            ...
            <?php $__currentLoopData = $mpesapayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mpesapayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="<?php echo e(url ('restoreMpesaPayment/'.$mpesapayment->id)); ?>">Restore</a></td>
                </tr>
...
<?php /**PATH D:\BITYARN\Salon-Booking\resources\views/ViewTrashedMpesaPayments.blade.php ENDPATH**/ ?>