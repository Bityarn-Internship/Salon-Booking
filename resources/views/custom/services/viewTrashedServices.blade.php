                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="col col-md-11 text-right">
                           <span style="display: inline-block"><h3><a class="btn btn-primary" href="{{url('restoreServices') }}"><b>Restore All</b>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            @foreach($services as $service)
                                <tr>
                                    ...
                                    <td>{{$service->name}}</td>
                                    <td>{{$service->cost}}</td>
                                    <td><a class="btn btn-primary" href="{{url ('restoreService/'.$service->id) }}" title="Restore">
