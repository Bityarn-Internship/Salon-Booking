<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Inactive Paypal Payments'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="col col-md-11 text-right">
                           <span style="display: inline-block"><h3><a class="btn btn-primary" href="<?php echo e(url('restorePaypalPayments')); ?>"><b>Restore All</b>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <?php $__currentLoopData = $paypalpayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paypalpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="<?php echo e(url ('restorePaypalPayment/'.$paypalpayment->id)); ?>" title="Restore">
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BITYARN\Salon-Booking\resources\views/custom/payments/viewTrashedPaypalPayments.blade.php ENDPATH**/ ?>