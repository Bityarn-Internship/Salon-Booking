...
@section('title')
    @lang('Inactive Employee Services')
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="col col-md-11 text-right">
                           <span style="display: inline-block"><h3><a class="btn btn-primary" href="{{url('restoreEmployeeServices') }}"><b>Restore All</b>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            @foreach($employeeServices as $employeeService)
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="{{url ('restoreEmployeeService/'.$employeeService->id) }}" title="Restore">
