...
<div class="container ">
    <div class="row">
    <div>
        <h3><a class="btn btn-primary" href="<?php echo e(url('restoreBookedServices')); ?>"><b>Restore All</b></a></h3>
    </div>
        <table id="bookedServicesView" class="table table-striped" style="width:100%">
            ...
            <?php $__currentLoopData = $bookedServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookedService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="<?php echo e(url ('restoreBookedService/'.$bookedService->id)); ?>">Restore</a></td>
                </tr>
...
<?php /**PATH D:\BITYARN\Salon-Booking\resources\views/ViewTrashedBookedServices.blade.php ENDPATH**/ ?>