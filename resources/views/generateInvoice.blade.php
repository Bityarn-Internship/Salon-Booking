...
<head>
    ...
    <title>Salon Booking | Invoice {{ $booking->id }}</title>
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="fw-bold">{{ \App\Http\Controllers\ServicesController::getServiceCost($bookedService->serviceID).' KES'}}</td>
            ...
            <tr>
                ...
                <td colspan="1" class="total-heading">{{$booking->cost.' KES'}}</td>
            </tr>
        </tbody>
    </table> 
    ...
    <p class = "text-center">
        <a href="{{url ('generateInvoice/'.$booking->id.'/generate') }}"><button>Download Invoice</button></a>
    </p>
