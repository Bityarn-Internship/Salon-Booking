            ...
            <center>
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mt-0">Hello <?php echo e(Auth::user()->firstName." ".Auth::user()->lastName); ?>,</br>Thank you for booking with us.</p>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Projects\Bityarn\salonBooking\resources\views//depositPayment.blade.php ENDPATH**/ ?>