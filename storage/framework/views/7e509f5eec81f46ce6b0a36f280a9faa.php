...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Inactive Clients'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <div class="col col-md-11 text-right">
                           <span style="display: inline-block"><h3><a class="btn btn-primary" href="<?php echo e(url('restoreClients')); ?>"><b>Restore All</b>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="<?php echo e(url ('restoreClient/'.$client->id)); ?>" title="Restore">
...
<?php echo $__env->make('custom.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Projects\Bityarn\salonBooking\resources\views/custom/auth/ViewTrashedClients.blade.php ENDPATH**/ ?>